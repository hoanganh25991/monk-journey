...
const ASSETS_TO_CACHE = [
  ...
  'js/entities/enemies/models/FrostMonarchModel.js',
  ...
  'js/entities/enemies/models/SpiderQueenModel.js',
  'js/entities/enemies/models/SwampHorrorModel.js',
  ...
  'js/entities/items/models/accessory/RingModel.js',
  'js/entities/items/models/accessory/TalismanModel.js',
  'js/entities/items/models/armor/BeltModel.js',
  'js/entities/items/models/armor/BootsModel.js',
  'js/entities/items/models/armor/GlovesModel.js',
  ...
  'js/entities/player/PlayerStatusEffects.js',
  ...
  'js/entities/skills/BulShadowCloneEffect.js',
